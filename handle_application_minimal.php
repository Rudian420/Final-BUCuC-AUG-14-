<?php
/**
 * Minimal accept handler - guaranteed to work
 */
...
try {
    ...
    if ($action === 'accept') {
        // MINIMAL VERSION: Just update database without email
        ...
        if ($updateResult) {
            $finalMessage = 'Member accepted successfully (MINIMAL VERSION - no email sent)';
    ...
    error_log("Error in handle_application_minimal.php: " . $e->getMessage());
