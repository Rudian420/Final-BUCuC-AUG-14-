                        ...
                        <tbody>
                            <?php if (!empty($venues)): ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($venue['venue_startingTime'] . ' - ' . $venue['venue_endingTime']); ?></td>
                                    <td><?php echo htmlspecialchars($venue['venu_ampm']); ?></td>
                                    <td>
                                        <button class="btn btn-delete btn-sm" onclick="deleteVenue(<?php echo $venue['venue_id']; ?>)">
