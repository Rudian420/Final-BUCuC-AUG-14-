        ...
        <div class="admin-form-card">
            ...
            <div class="info-box">
                ...
                <small>
                    ...
                    <br><strong>Current User:</strong> <?= htmlspecialchars($_SESSION['username']) ?> (<?= $_SESSION['admin_role'] ?>)
                </small>
            </div>
            ...
            <div class="info-box mt-4">
                ...
                <small>
                    <strong>Fields:</strong> id (auto), username, email, password (hashed), role, status (auto: active), created_at (auto)
