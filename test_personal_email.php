...
function testEmailConfiguration() {
    ...
    if (strpos(SMTP_USERNAME, 'your.email@gmail.com') !== false || 
        strpos(SMTP_USERNAME, 'your.email@outlook.com') !== false ||
        strpos(SMTP_USERNAME, 'your.email@yahoo.com') !== false ||
        strpos(SMTP_PASSWORD, 'your_app_password') !== false ||
        strpos(SMTP_PASSWORD, 'your_password') !== false) {
        echo "<div style='background: #fff3cd; border: 1px solid #ffeaa7; padding: 15px; border-radius: 5px; margin: 20px 0;'>";
        echo "<h4>⚠️ Configuration Required</h4>";
        echo "<p>Please update the email credentials in <code>config/email_config.php</code> with your actual personal email details.</p>";
        echo "</div>";
        return false;
    }
